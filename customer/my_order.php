<div class="box">
	...
	<P> If you have any questions, please feel free to <a href="../contactus.php">Contact us, our customer service center is working for you 24/7. </a></P>
</center>
<hr>
<div class="table-responsive">
	<table class="table table-bordered table-hover">
		...
		<tbody>
			...
			$run_cust=mysqli_fetch_array($run_cust);
			$customer_id=$run_cust['customer_id'];
			$get_order="select * from customer_order where customer_id='$customer_id'";
			$run_order=mysqli_query($con,$get_order);
			$i=0;
			while ($row_order=mysqli_fetch_array($run_order)) {
				$order_id=$row_order['order_id'];
				$order_due_amount=$row_order['due_amt'];
